...
const { purchaseRole, createCustomRole, getBalance, ROLE_PRICE } = require('../../utils/economy/shopManager.js');
...
module.exports = {
  ...
  async execute(interaction) {
    ...
    // We'll handle modal submission in interactionCreate event
  }
};
